...
(1, 1, 0, '2019-12-24 09:17:00'),
(2, 1, 0, '2019-12-24 09:22:42'),
(3, 1, 0, '2019-12-24 09:22:46');
...
(1, 3, 10, '2019-12-24 13:24:48'),
(2, 3, 11, '2019-12-24 13:39:04');
...
--
-- Dumping data for table `uc_quiz_attempt`
--

INSERT INTO `uc_quiz_attempt` (`attempt_id`, `result_id`, `question_id`, `answer`) VALUES
(7, 2, 7, 3),
(8, 2, 8, 2),
(9, 2, 9, 4),
(10, 2, 16, 2),
...
--
-- Dumping data for table `uc_quiz_result`
--

INSERT INTO `uc_quiz_result` (`result_id`, `batch_id`, `team_id`, `attempted`, `not_attempted`, `right`, `wrong`, `marks_obtained`, `total_marks`) VALUES
(2, 3, 11, 6, 83, 3, 3, 0, 112);
...
(6, '2asdw', 'asda', 'adasd'),
(7, 'ashdg', 'kjshad', 'ldkn'),
(8, 'Team 2', 'asda', 'asdsads'),
(9, 'asdasdasd', 'saddf', 'sdvz'),
(10, 'Team_23', 'asdasdasd', 'asdasdasds'),
(11, 'Team222', 'asd', 'ddsc');
...
--
ALTER TABLE `uc_batch_team`
  MODIFY `batch_team_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
